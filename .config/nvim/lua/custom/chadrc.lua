...
M.mappings = {
   ...
   new_buffer = "<S-n>", -- open a new buffer
...
M.mappings.plugins = {
   ...
   dashboard = {
      bookmarks = "<leader>bm",
      new_file = "<leader>n", -- basically create a new buffer
